...
module.exports     = function(S) {
    ...
    class FunctionRun extends S.classes.Plugin {
        ...
        _runLocal() {
            ...
            return this.function.run(this.evt.options.stage, this.evt.options.region, this.evt.options.event)
        ...
        _runDeployed() {
            ...
            let params = {
                ...
                Payload: new Buffer(JSON.stringify(_this.evt.options.event || SUtils.readFileSync(_this.function.getRootPath('event.json')))),
